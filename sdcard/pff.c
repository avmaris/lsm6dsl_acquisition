...
#include "../sdcard/pff.h"        /* Petit FatFs configurations and declarations */
#include "../sdcard/diskio.h"     /* Declarations of low level disk I/O functions */
...
)
{
    ...
    if (disk_initilize___() & STA_NOINIT) /* Check if the drive is ready or not */
        return FR_NOT_READY;
